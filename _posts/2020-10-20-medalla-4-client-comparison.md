...
---
In this article, we will attempt to compare the performance of the different eth2 clients participating in the Medalla testnet. These clients are:
...
We've already made a guess at which client each validator was running as part of [data pre-processing](/posts/medalla-data-prep), we'll now take a look at how theycompared.
